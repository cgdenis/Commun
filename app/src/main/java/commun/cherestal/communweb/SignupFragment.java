...
public class SignupFragment extends Fragment implements Constants {
    ...
    String googleId="", googleName="", googleEmail="", googleUsername="";
    SignInButton yourButton;
...
//                                Toast.makeText(getApplicationContext(), error.getMessage(), Toast.LENGTH_LONG).show();
        ...
        yourButton = (SignInButton) rootView.findViewById(R.id.sign_in_button);
        yourButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                // TODO Auto-generated method stub
                Intent i = new Intent(getActivity(),GoogleSignInActivity.class);
                i.putExtra("methodName", "signUpWithGoogle");
        ...
        switch (requestCode){
            case 1:
                if (resultCode == 2651) {
                    ...
                    String strEditText3 = data.getStringExtra("googleUsername");
                    yourButton.setVisibility(View.GONE);
                    googleEmail = strEditText;
                    googleName=strEditText2;
                    googleUsername=strEditText3;
                    loginButton.setVisibility(View.GONE);
                    ...
                    signupFullname.setText(googleName);
                    // signupUsername.setText(googleUsername);
