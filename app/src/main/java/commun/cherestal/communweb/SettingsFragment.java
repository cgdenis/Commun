...
public class SettingsFragment extends PreferenceFragment implements Constants{
    ...
    GoogleSignInActivity mGoogleSignIn;
...
//                    alertDialog.setMessage("Version " + APP_VERSION + "/r/n" + APP_COPYRIGHT);
    ...
    //Initialize GoogleSignIn Client to Sign in and Sign out
    @Override
    public void onStart() {
    ...
    //Disconnect Google account from app. User has to select app to sign in again
