...
import commun.cherestal.communweb.dialogs.CoverChooseDialog;
import commun.cherestal.communweb.dialogs.FriendRequestActionDialog;
...
import commun.cherestal.communweb.dialogs.PeopleNearbySettingsDialog;
import commun.cherestal.communweb.dialogs.PeopleNearbySexDialog;
import commun.cherestal.communweb.dialogs.PhotoChooseDialog;
...
import commun.cherestal.communweb.dialogs.ProfileBlockDialog;
import commun.cherestal.communweb.dialogs.ProfileReportDialog;
import commun.cherestal.communweb.dialogs.SearchSettingsDialog;
...
public class MainActivity extends ActivityBase implements FragmentDrawer.FragmentDrawerListener, PhotoChooseDialog.AlertPositiveListener, CoverChooseDialog.AlertPositiveListener, ProfileReportDialog.AlertPositiveListener, ProfileBlockDialog.AlertPositiveListener, PostDeleteDialog.AlertPositiveListener, PostReportDialog.AlertPositiveListener, MyPostActionDialog.AlertPositiveListener, PostActionDialog.AlertPositiveListener, PostShareDialog.AlertPositiveListener, PhotoDeleteDialog.AlertPositiveListener, MyPhotoActionDialog.AlertPositiveListener, PeopleNearbySettingsDialog.AlertPositiveListener, SearchSettingsDialog.AlertPositiveListener, FriendRequestActionDialog.AlertPositiveListener, PeopleNearbySexDialog.AlertPositiveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Start methods from UserInformation.class that retrieve data from firebase onDataChange
        startUserInfoMethods();
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 3: {
                ...
                getSupportActionBar().setTitle("MapsActivity");
    ...
    public void startUserInfoMethods(){
        UserInfomation.getUserLocbyId(App.getInstance().getId());
    }
}
