...
public class MapsActivity extends AppCompatActivity{
    ...
    private double mapRadius = 8046.72;
    Circle drawncircle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mapsFragment = getSupportFragmentManager().getFragment(savedInstanceState, "currentFragment");
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container_body, mapsFragment)
                .commit();
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        getSupportFragmentManager().putFragment(outState, "currentFragment", mapsFragment);
    }
