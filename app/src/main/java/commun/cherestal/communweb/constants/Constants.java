package commun.cherestal.communweb.constants;
...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIz1aSyAz8TvzJtYkvsNNaRsQz2Td9atmQZOyc32OTk";
    ...
    public static final String WEB_SITE = "http://www.thecommun.us/";  //web site url address

    // Client ID For identify the application | Must be the same with CLIENT_ID from server config: db.inc.php

    public static final String CLIENT_ID = "1753";  // Correct example: 12567 | Incorrect example: 0987

    public static final String API_DOMAIN = "http://www.thecommun.us/";  // url address to which the application sends requests
    ...
    public static final String METHOD_ACCOUNT_LOGINGOOGLE = API_DOMAIN + "api/" + API_VERSION + "/method/account.signInByGoogle" + API_FILE_EXTENSION;
